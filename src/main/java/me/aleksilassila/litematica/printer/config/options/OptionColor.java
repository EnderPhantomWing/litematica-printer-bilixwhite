...
public class OptionColor extends ConfigColor {
    ...
    private OptionColor(I18n i18n, String defaultValue, String delimiter, Component... comments) {
    ...
    public static OptionColor create(I18n i18n, String defaultValue, String delimiter, Component... comments) {
