...
public class OptionBooleanHotkeyed extends ConfigBooleanHotkeyed {
    ...
    private OptionBooleanHotkeyed(I18n i18n, boolean defaultValue, String defaultHotkey, String delimiter, Component... comments) {
    ...
    public static OptionBooleanHotkeyed create(I18n i18n, boolean defaultValue, String defaultHotkey, String delimiter, Component... comments) {
        return new OptionBooleanHotkeyed(i18n, defaultValue, defaultHotkey, delimiter, comments);
    }

    public static OptionBooleanHotkeyed create(I18n i18n, boolean defaultValue, String defaultHotkey, Component... comments) {
